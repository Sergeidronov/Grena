...
const Config = {
    GuildID: "936118491377958934",
    StaffChannelID: "936118491717718075",
    StaffMessageID: "936197514288308254"
}
...
module.exports = {
    ...
    execute(client) {
        ...
        setInterval(async function () {
            ...
            Staff.forEach((staff) => {
                List
                .addFields({ name: `${staff}:`,
                 value: `${client.guilds.cache.get(Config.GuildID).roles.cache.find(r => r.name == staff)
                    .members.map(m => `${m.user}, `).join("") || "⠀"}`, inline: false })
            })
